        ...
        <div className="mb-6">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-sm font-medium bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 border border-blue-500/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
